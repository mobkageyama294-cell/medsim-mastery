      ...
      >
        <AnimatePresence mode="wait">
          {step === 'credentials' ? (
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-primary/20 flex items-center justify-center mb-6 shadow-lg shadow-primary/10">
                <ShieldCheck className="w-8 h-8 text-primary" />
              </div>

              <h2 className="text-xl font-bold text-foreground mb-1">Verificação em Duas Etapas</h2>
              <p className="text-sm text-muted-foreground text-center mb-8 max-w-xs">
                Insira o código de 6 dígitos enviado para <span className="text-foreground font-medium">{email}</span>
              </p>
